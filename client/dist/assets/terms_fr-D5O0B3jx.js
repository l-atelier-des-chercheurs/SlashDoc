const e=`# CONDITIONS GÉNÉRALES D’UTILISATION (CGU) – /doc (DocSpaces)
...
Clara Kernreuter, Designer, agissant pour le compte d’Atelier LUMA, ou Mustapha Bouhayati, Président de la SAS Luma/Arles.
...
Le site est hébergé par LUMA Arles.
...
- consent expressément à ce que les contenus déposés puissent être :
  ...
  - réutilisés, adaptés, traduits et documentés à nouveau ;
...
Toutefois, dans une logique de biens communs, les utilisateurs acceptent que leurs contributions participent à un patrimoine collectif de connaissances destiné à être enrichi et transmis au-delà de ses auteur·rices initiaux.

Toute exploitation des contenus en contradiction avec l’esprit des licences open source, ou visant à en restreindre abusivement l’accès, pourra faire l’objet de mesures correctives.
...
Les utilisateurs disposent d’un droit d’accès, de rectification, de suppression et d’opposition concernant leurs données personnelles, conformément aux textes en vigueur.
